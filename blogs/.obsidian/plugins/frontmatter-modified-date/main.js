...
var FrontmatterModifiedSettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian.Setting(containerEl)
      ...
      .setDesc(
        "Optional. Add a created property name, and the plugin will also update the note creation date.",
      )
      .addText((text) =>
        text
    ...
    new import_obsidian.Setting(containerEl)
      ...
      .setDesc(
        `Instead of storing only the last modified time, this will turn your "${this.plugin.settings.frontmatterProperty}" frontmatter property into a list of all of the dates/times you've edited this note.`,
      )
      .addToggle((toggle) => {
    ...
    if (this.plugin.settings.storeHistoryLog) {
      new import_obsidian.Setting(containerEl)
        ...
        .setDesc(
          "The plugin will store a maximum of 1 history entry per minute, hour, day, etc. If there are multiple edits in the specified period, the last edit entry will be updated instead.",
        )
      ...
      new import_obsidian.Setting(containerEl)
        ...
        .addText((text) =>
          text
            ...
            .setValue(
              this.plugin.settings.historyMaxItems === 0
                ? ""
                : this.plugin.settings.historyMaxItems.toString(),
            )
            .onChange(async (value) => {
...
after this change.`,
    ...
    new import_obsidian.Setting(containerEl)
      ...
      .setDesc(
        'How many seconds to wait after the last edit before updating the modified field. You can increase this value if you are experiencing too many "Merging changes" popups.',
      )
      .addText((text) =>
        text
          .setPlaceholder("10")
        ...
        try {
          if (
            (_a = event == null ? void 0 : event.target) == null
              ? void 0
              : _a.closest(".markdown-source-view > .cm-editor")
          ) {
    ...
    this.timer[file.path] = window.setTimeout(() => {
      ...
      if (
        ...
        !((_a = cache == null ? void 0 : cache.frontmatter) == null
          ? void 0
          : _a.hasOwnProperty(this.settings.frontmatterProperty))
      ) {
      } else if (
        (_b = cache == null ? void 0 : cache.frontmatter) == null
          ? void 0
          : _b[this.settings.excludeField]
      ) {
      } else if (
        ...
        const isAppendArray =
          this.settings.storeHistoryLog ||
          ((_c = cache == null ? void 0 : cache.frontmatter) == null
            ? void 0
            : _c[this.settings.appendField]) === true
        const desc = this.settings.historyNewestFirst
        let secondsSinceLastUpdate = Infinity
        let previousEntryMoment
        if (
          (_d = cache == null ? void 0 : cache.frontmatter) == null
            ? void 0
            : _d[this.settings.frontmatterProperty]
        ) {
          let previousEntry =
            (_e = cache == null ? void 0 : cache.frontmatter) == null
              ? void 0
              : _e[this.settings.frontmatterProperty]
          if (isAppendArray && Array.isArray(previousEntry)) {
            previousEntry = previousEntry[desc ? 0 : previousEntry.length - 1]
          }
          previousEntryMoment = (0, import_obsidian2.moment)(
            previousEntry,
        ...
        if (secondsSinceLastUpdate > 30) {
          ...
          if (isAppendArray) {
            let entries =
              ((_f = cache == null ? void 0 : cache.frontmatter) == null
                ? void 0
                : _f[this.settings.frontmatterProperty]) || []
            ...
            if (entries.length) {
              ...
              if (this.settings.historyMaxItems && entries.length > this.settings.historyMaxItems) {
                entries = desc
                  ? entries.slice(0, this.settings.historyMaxItems)
                  : entries.slice(-this.settings.historyMaxItems)
              }
            } else {
          ...
          this.app.fileManager.processFrontMatter(file, (frontmatter) => {
            ...
            if (
              ...
              !frontmatter[this.settings.createdDateProperty]
            ) {
              frontmatter[this.settings.createdDateProperty] = (0, import_obsidian2.moment)(
                file.stat.ctime,
