  ...
  Ui = (r, e, t) => {
    if ((e && typeof e == "object") || typeof e == "function")
      for (let n of Gi(e))
        !Wi.call(r, n) &&
          n !== "default" &&
          or(r, n, { get: () => e[n], enumerable: !(t = Hi(e, n)) || t.enumerable })
    return r
  },
  V = (r) =>
    Ui(
...
var Mn = (() => {
  ...
  return (t) => {
    for (
      var n = t.length,
        o = new Uint8Array((((n - (t[n - 1] == "=") - (t[n - 2] == "=")) * 3) / 4) | 0),
        s = 0,
        a = 0;
      s < n;
      ...
      var A = r[t.charCodeAt(s++)],
        ...
        d = r[t.charCodeAt(s++)],
        f = r[t.charCodeAt(s++)]
      ;(o[a++] = (A << 2) | (c >> 4)), (o[a++] = (c << 4) | (d >> 2)), (o[a++] = (d << 6) | f)
    }
    return o
  }
})()
...
function je(r, e, t) {
  ...
  var a = he(r) ? L(r) : window,
    ...
    b = n.width / o,
    k = n.height / s
  return { width: b, height: k, top: f, right: d + b, bottom: f + k, left: d, x: d, y: f }
}
function ut(r) {
  var e = je(r),
    t = r.offsetWidth,
...
function ie(r) {
  return ((he(r) ? r.ownerDocument : r.document) || window.document).documentElement
}
function Ue(r) {
  return re(r) === "html" ? r : r.assignedSlot || r.parentNode || (kt(r) ? r.host : null) || ie(r)
}
function Nn(r) {
...
function Ee(r) {
  for (var e = L(r), t = Nn(r); t && Fr(t) && Ae(t).position === "static"; ) t = Nn(t)
  return t && (re(t) === "html" || (re(t) === "body" && Ae(t).position === "static"))
    ? e
    : t || ao(r) || e
}
function mt(r) {
...
function po(r) {
  ...
  if (!(!s || !a)) {
    var b = lo(o.padding, t),
      ...
      x = c === "y" ? W : U,
      O = c === "y" ? ee : Q,
      P = t.rects.reference[f] + t.rects.reference[c] - a[c] - t.rects.popper[f],
...
function Yn(r) {
  ...
  return Object.assign(
    {},
    m,
    ((e = {}), (e[T] = Y ? P + "px" : ""), (e[N] = B ? x + "px" : ""), (e.transform = ""), e),
  )
}
function mo(r) {
  var e = r.state,
...
var Hn = { name: "computeStyles", enabled: !0, phase: "beforeWrite", fn: mo, data: {} }
var cr = { passive: !0 }
function fo(r) {
  var e = r.state,
    t = r.instance,
...
function Pr(r) {
  var e,
    ...
    s = xe(t.scrollWidth, t.clientWidth, o ? o.scrollWidth : 0, o ? o.clientWidth : 0),
    a = xe(t.scrollHeight, t.clientHeight, o ? o.scrollHeight : 0, o ? o.clientHeight : 0),
    A = -n.scrollLeft + gt(r),
    c = -n.scrollTop
  return (
    Ae(o || t).direction === "rtl" && (A += xe(t.clientWidth, o ? o.clientWidth : 0) - s),
...
function qr(r, e) {
  ...
  var x = k.reduce(function (O, P) {
    return (O[P] = ke(r, { placement: P, boundary: o, rootBoundary: s, padding: a })[ne(P)]), O
  }, {})
  ...
  if (!e.modifiersData[n]._skip) {
    for (
      ...
      var m = T[G],
        ...
        we = [W, ee].indexOf(h) >= 0,
        me = we ? "width" : "height",
        oe = ke(e, { placement: m, boundary: f, rootBoundary: b, altBoundary: k, padding: d }),
        se = we ? (p ? Q : U) : p ? ee : W
      I[me] > C[me] && (se = Ft(se))
      var Pe = Ft(se),
        fe = []
...
var zn = { name: "hide", enabled: !0, phase: "main", requiresIfExists: ["preventOverflow"], fn: bo }
function yo(r, e, t) {
  var n = ne(r),
    ...
    a = s[0],
    A = s[1]
  return (a = a || 0), (A = (A || 0) * o), [U, Q].indexOf(n) >= 0 ? { x: A, y: a } : { x: a, y: A }
}
function xo(r) {
  var e = r.state,
    t = r.options,
...
var Jn = { name: "offset", enabled: !0, phase: "main", requires: ["popperOffsets"], fn: xo }
function Eo(r) {
  var e = r.state,
    t = r.name
...
var Xn = { name: "popperOffsets", enabled: !0, phase: "read", fn: Eo, data: {} }
function Or(r) {
  return r === "x" ? "y" : "x"
}
function ko(r) {
  ...
  if (!!C) {
    if (s) {
      var p,
        ...
        le = N ? -R[oe] / 2 + _t + Re + H + G.mainAxis : Ne + Re + H + G.mainAxis,
...
function Sr(r, e, t) {
  ...
  return (
    (n || (!n && !t)) &&
      ...
      te(e) ? ((c = je(e, !0)), (c.x += e.clientLeft), (c.y += e.clientTop)) : s && (c.x = gt(s))),
    {
      ...
      x = {
        ...
        setOptions: function (B) {
          ...
          P(),
            ...
            (f.scrollParents = {
              reference: he(A) ? tt(A) : A.contextElement ? tt(A.contextElement) : [],
              popper: tt(c),
            })
    ...
    constructor(e, t, n) {
      ;(this.owner = e),
        ...
        n.register([], "ArrowUp", (o) => {
          if (!o.isComposing) return this.setSelectedItem(this.selectedItem - 1, !0), !1
        }),
          ...
          modifiers: [
            {
              ...
              fn: ({ state: n, instance: o }) => {
                ...
                n.styles.popper.width !== s && ((n.styles.popper.width = s), o.update())
              },
              phase: "beforeWrite",
              requires: ["computeStyles"],
            },
...
var Pt = class extends Ht {
  ...
  getSuggestions(e) {
    let t = ce(() => Ie(this.plugin.app, this.get_folder(this.mode)), this.get_error_msg(this.mode))
    if (!t) return []
    let n = [],
      o = e.toLowerCase()
    return (
...
var Gt = class extends Ht {
  ...
  getSuggestions(e) {
    ...
    return (
      t.forEach((s) => {
        s instanceof oi.TFolder && s.path.toLowerCase().contains(o) && n.push(s)
      }),
      n.slice(0, 1e3)
    )
  }
  ...
  Lr = class extends M.PluginSettingTab {
        ...
        .addSearch((e) => {
          new Gt(this.app, e.inputEl),
            e
              ...
              .onChange((t) => {
                ;(this.plugin.settings.templates_folder = t), this.plugin.save_settings()
              }),
    ...
    add_internal_functions_setting() {
      ...
      e.append(
        ...
        new M.Setting(this.containerEl).setName("Internal variables and functions").setDesc(e)
    }
    add_syntax_highlighting_settings() {
      ...
      t.append(
        ...
        new M.Setting(this.containerEl)
          ...
          .setDesc(e)
          .addToggle((n) => {
            n.setValue(this.plugin.settings.syntax_highlighting).onChange((o) => {
        ...
        new M.Setting(this.containerEl)
          ...
          .setDesc(t)
          .addToggle((n) => {
            n.setValue(this.plugin.settings.syntax_highlighting_mobile).onChange((o) => {
    ...
    add_auto_jump_to_cursor() {
      ...
      e.append(
        ...
        new M.Setting(this.containerEl)
          ...
          .setDesc(e)
          .addToggle((t) => {
            t.setValue(this.plugin.settings.auto_jump_to_cursor).onChange((n) => {
              ;(this.plugin.settings.auto_jump_to_cursor = n), this.plugin.save_settings()
            })
          })
    }
    add_trigger_on_new_file_creation_setting() {
      ...
      e.append(
        ...
        new M.Setting(this.containerEl)
          ...
          .setDesc(e)
          .addToggle((t) => {
            t.setValue(this.plugin.settings.trigger_on_file_creation).onChange((n) => {
    ...
    add_folder_templates_setting() {
      ...
      t.append(
        ...
        new M.Setting(this.containerEl)
          ...
          .setDesc(t)
          .addToggle((n) => {
            n.setValue(this.plugin.settings.enable_folder_templates).onChange((o) => {
              ...
              .addSearch((a) => {
                new Gt(this.app, a.inputEl),
                  a
                    ...
                    .setValue(n.folder)
                    .onChange((A) => {
                      if (A && this.plugin.settings.folder_templates.some((c) => c.folder == A)) {
                        K(new w("This folder already has a template associated with it"))
                        return
                      }
    ...
    add_file_templates_setting() {
      new M.Setting(this.containerEl).setName("File regex templates").setHeading()
      let e = document.createDocumentFragment()
      e.append(
      ...
      t.append(
        ...
        new M.Setting(this.containerEl)
          ...
          .setDesc(t)
          .addToggle((n) => {
            n.setValue(this.plugin.settings.enable_file_templates).onChange((o) => {
            ...
            new M.Setting(this.containerEl)
              .addText((a) => {
                a
                  ...
                  .setValue(n.regex)
                  .onChange((A) => {
                    ;(this.plugin.settings.file_templates[o].regex = A), this.plugin.save_settings()
                  }),
              ...
              new Pt(s.inputEl, this.plugin, Te.TemplateFiles),
                s
                  ...
                  .onChange((a) => {
                    ...
                    ;(this.plugin.settings.startup_templates[n] = a), this.plugin.save_settings()
                  }),
                s.containerEl.addClass("templater_search")
            })
            .addExtraButton((s) => {
    ...
    add_user_script_functions_setting() {
      new M.Setting(this.containerEl).setName("User script functions").setHeading()
      let e = document.createDocumentFragment()
      e.append(
          ...
          .addSearch((n) => {
            new Gt(this.app, n.inputEl),
              n
                ...
                .onChange((o) => {
                  ;(this.plugin.settings.user_scripts_folder = o), this.plugin.save_settings()
                }),
      ...
      if (!this.plugin.settings.user_scripts_folder) t = "No user scripts folder set"
        ...
        if (!n || n.length === 0) t = "No user scripts detected"
          ...
          for (let s of n)
            s.extension === "js" &&
              (o++, e.append(e.createEl("li", { text: `tp.user.${s.basename}` })))
    ...
    add_user_system_command_functions_setting() {
      ...
      if (
        ...
        new M.Setting(this.containerEl).setName("User system command functions").setHeading(),
        new M.Setting(this.containerEl)
          .setName("Enable user system command functions")
          .setDesc(e)
          .addToggle((t) => {
            t.setValue(this.plugin.settings.enable_system_commands).onChange((n) => {
          ...
          .addText((s) => {
            s.setPlaceholder("Timeout")
              ...
              .onChange((a) => {
                ...
                ;(this.plugin.settings.command_timeout = A), this.plugin.save_settings()
              })
          }),
          (e = document.createDocumentFragment()),
          e.append(
        ...
        this.plugin.settings.templates_pairs.forEach((s) => {
          ...
          let A = this.containerEl.createEl("h4", { text: "User function n\xB0" + t })
          A.addClass("templater_title"),
            new M.Setting(this.containerEl)
              ...
              .addTextArea((d) => {
                ...
                return f.inputEl.setAttr("rows", 2), f.inputEl.addClass("templater_cmd"), f
              })
              .infoEl.remove(),
            a.appendChild(A),
    ...
    add_donating_setting() {
      ...
      o.setAttribute("href", "https://www.paypal.com/donate?hosted_button_id=U2SRGAFYXT32Q"),
        o.addClass("templater_donating")
      let s = document.createElement("img")
      ;(s.src = "https://img.shields.io/badge/paypal-silentvoid13-yellow?style=social&logo=paypal"),
        o.appendChild(s),
...
var pi = 10,
  Gr = class extends ue {
    ...
    generate_create_new() {
      return async (e, t, n = !1, o) => {
        if (((this.create_new_depth += 1), this.create_new_depth > pi))
          throw ((this.create_new_depth = 0), new w("Reached create_new depth limit (max = 10)"))
        let s = await this.plugin.templater.create_new_note_from_template(e, o, t, n)
        return (this.create_new_depth -= 1), s
      }
    }
    generate_creation_date() {
      return (e = "YYYY-MM-DD HH:mm") => (0, Z.moment)(this.config.target_file.stat.ctime).format(e)
    }
    generate_cursor() {
    ...
    generate_include() {
      return async (e) => {
        if (((this.include_depth += 1), this.include_depth > pi))
          throw ((this.include_depth -= 1), new w("Reached inclusion depth limit (max = 10)"))
        let t
        if (e instanceof Z.TFile) t = await this.plugin.app.vault.read(e)
          ...
          if ((n = this.linkpath_regex.exec(e)) === null)
            throw (
              ...
              new w("Invalid file format, provide an obsidian link between quotes."))
            )
          let { path: o, subpath: s } = (0, Z.parseLinktext)(n[1]),
            a = this.plugin.app.metadataCache.getFirstLinkpathDest(o, "")
          if (!a) throw ((this.include_depth -= 1), new w(`File ${e} doesn't exist`))
    ...
    generate_last_modified_date() {
      return (e = "YYYY-MM-DD HH:mm") => (0, Z.moment)(this.config.target_file.stat.mtime).format(e)
    }
    generate_move() {
      return async (e, t) => {
    ...
    generate_rename() {
      return async (e) => {
        if (e.match(/[\\/:]+/g))
          throw new w("File name cannot contain any of these characters: \\ / :")
    ...
    generate_selection() {
      return () => {
        ...
        if (!e || !e.editor) throw new w("Active editor is null, can't read selection.")
...
var Vr = class extends ue {
  ...
  async getRequest(e) {
    try {
      ...
      if (t.status < 200 && t.status >= 300) throw new w("Error performing GET request")
      return t
    } catch {
...
> \u2014 ${s}`
        ...
        return new w("Error generating daily quote"), "Error generating daily quote"
      }
    }
  }
  generate_random_picture() {
    return async (e, t, n = !1) => {
      try {
        ...
        return new w("Error generating random picture"), "Error generating random picture"
      }
    }
  }
  generate_request() {
...
var Ur = class extends Se.Modal {
  ...
  onClose() {
    this.contentEl.empty(), this.submitted || this.reject(new w("Cancelled prompt"))
  }
  createForm() {
  ...
  enterCallback(e) {
    e.isComposing ||
      e.keyCode === 229 ||
      (this.multi_line
        ? Se.Platform.isDesktop && e.key === "Enter" && !e.shiftKey && this.resolveAndClose(e)
...
var Qr = class {
  ...
  async generate_object(e) {
    let t = {}
    for (let n of this.modules_array) t[n.getName()] = await n.generate_object(e)
    return t
  }
}
...
var Zr = class {
  constructor(e) {
    this.plugin = e
    if (Vt.Platform.isMobile || !(this.plugin.app.vault.adapter instanceof Vt.FileSystemAdapter))
      this.cwd = ""
    else {
  ...
  async generate_system_functions(e) {
    let t = new Map(),
      n = await this.plugin.templater.functions_generator.generate_object(e, De.INTERNAL)
...
var en = class {
  ...
  async generate_user_script_functions() {
    ...
    if (!t) return new Map()
    for (let n of t)
      n.extension.toLowerCase() === "js" && (await this.load_user_script_function(n, e))
    return e
  }
  async load_user_script_function(e, t) {
    ...
    if (!A) throw new w(`Failed to load user script at "${e.path}". No exports detected.`)
    if (!(A instanceof Function))
      throw new w(`Failed to load user script at "${e.path}". Default export is not a function.`)
    t.set(`${e.basename}`, A)
  }
...
var tn = class {
  constructor(e) {
    this.plugin = e
    ;(this.user_system_functions = new Zr(e)), (this.user_script_functions = new en(e))
  }
  async generate_object(e) {
    let t = {},
      n = {}
...
var rn = class {
  constructor(e) {
    this.plugin = e
    ;(this.internal_functions = new Qr(this.plugin)), (this.user_functions = new tn(this.plugin))
  }
  async init() {
  ...
  async generate_object(e, t = 1) {
    ...
    switch ((Object.assign(n, o), t)) {
      case 0:
        ...
        break
      case 1:
        ;(a = await this.user_functions.generate_object(e)), Object.assign(n, { ...s, user: a })
        break
    }
    return n
  }
...
var Kt = class {
  ...
  async parse_template(e, t) {
    ...
    return (this.current_functions_object = n), await this.parser.parse_commands(t, n)
  }
  ...
  async append_template_to_active_file(e) {
    ...
    let s = this.create_running_config(e, n.file, 1),
      a = await ye(async () => this.read_and_parse_template(s), "Template parsing error, aborting.")
    if (a == null) {
  ...
  async write_template_to_file(e, t) {
    ...
    let o = this.plugin.app.workspace.activeEditor,
      ...
      A = await ye(async () => this.read_and_parse_template(a), "Template parsing error, aborting.")
    if (A == null) {
  ...
  async overwrite_file_commands(e, t = !1) {
    ...
    let o = this.create_running_config(e, e, t ? 3 : 2),
      s = await ye(async () => this.read_and_parse_template(o), "Template parsing error, aborting.")
    if (s == null) {
      await this.end_templater_task(n)
      return
    }
    await this.plugin.app.vault.modify(e, s),
      this.plugin.app.workspace.trigger("templater:overwrite-file", { file: e, content: s }),
  ...
  async process_dynamic_templates(e, t) {
    ...
    for (; (s = o.nextNode()); ) {
      ...
      if (c !== null) {
        let d = n.exec(c)
        if (d !== null) {
          let f = this.plugin.app.metadataCache.getFirstLinkpathDest("", t.sourcePath)
          if (!f || !(f instanceof ve.TFile)) return
          if (!a) {
            a = !0
            let b = this.create_running_config(f, f, 4)
            ;(A = await this.functions_generator.generate_object(b, De.USER_INTERNAL)),
  ...
  get_new_file_template_for_folder(e) {
    do {
      let t = this.plugin.settings.folder_templates.find((n) => n.folder == e.path)
      if (t && t.template) return t.template
      e = e.parent
    } while (e)
  }
  get_new_file_template_for_file(e) {
    let t = this.plugin.settings.file_templates.find((n) => new RegExp(n.regex).test(e.path))
    if (t && t.template) return t.template
  }
    ...
    if (
      ...
      if (n.stat.size == 0 && e.plugin.settings.enable_folder_templates) {
        ...
        n.stat.size <= 1e5
          ...
          : console.log(`Templater skipped parsing ${n.path} because file size exceeds 10000`)
  }
  async execute_startup_scripts() {
    for (let e of this.plugin.settings.startup_templates) {
      if (!e) continue
      let t = ce(() => lt(this.plugin.app, e), `Couldn't find startup template "${e}"`)
      if (!t) continue
      let { path: n } = t
      this.start_templater_task(n)
    ...
    update_trigger_file_on_creation() {
      this.settings.trigger_on_file_creation
        ? ((this.trigger_on_file_creation_event = this.plugin.app.vault.on("create", (e) =>
            Kt.on_file_creation(this.templater, this.plugin.app, e),
          )),
...
var cn = class {
  ...
  async jump_to_next_cursor_location() {
    ...
    let t = e.editor.getValue(),
      { new_content: n, positions: o } = this.replace_and_get_cursor_positions(t)
    if (o) {
...
`,
        ...
        include: {
          ...
          examples: [
            { name: "File include", example: '<% tp.file.include("[[Template1]]") %>' },
            {
    ...
    system: {
      ...
      functions: {
        ...
        prompt: {
          ...
          examples: [
            { name: "Prompt", example: '<% tp.system.prompt("Please enter a value") %>' },
            {
      ...
      functions: {
        ...
        random_picture: {
          ...
          examples: [
            ...
            { name: "Random picture with size", example: '<% tp.web.random_picture("200x200") %>' },
            {
...
var An = class {
  ...
  get_all_modules_documentation() {
    return Object.values(this.documentation.tp).map((e) => ((e.queryKey = e.name), e))
  }
...
var un = class extends wi.EditorSuggest {
  ...
  getSuggestions(e) {
    ...
    return (
      ...
      t ? t.filter((n) => n.queryKey.toLowerCase().startsWith(e.query.toLowerCase())) : []
    )
  }
  renderSuggestion(e, t) {
    t.createEl("b", { text: e.name }),
      t.createEl("br"),
      this.function_trigger && vi(e) && t.createEl("code", { text: e.definition }),
...
;(function (r) {
  ...
  r.defineMode("javascript", function (e, t) {
    ...
    function B(i, l) {
      ...
      if (u == "." && i.match(/^\d[\d_]*(?:[eE][+\-]?[\d_]+)?/)) return j("number", "number")
      if (u == "." && i.match("..")) return j("spread", "meta")
      if (/[\[\]{}\(\),;\:\.]/.test(u)) return j(u)
      if (u == "=" && i.eat(">")) return j("=>", "operator")
      if (u == "0" && i.match(/^(?:x[\dA-Fa-f_]+|o[0-7_]+|b[01_]+)n?/)) return j("number", "number")
      if (/\d/.test(u))
        return i.match(/^[\d_]*(?:n|(?:\.[\d_]*)?(?:[eE][+\-]?[\d_]+)?)?/), j("number", "number")
      if (u == "/")
        return i.eat("*")
          ? ((l.tokenize = N), N(i, l))
          : i.eat("/")
            ...
            : Tn(i, l, 1)
              ? (x(i), i.match(/^\b(([gimyus])(?![gimyus]*\2))+\b/), j("regexp", "string-2"))
      ...
      if (b.test(u))
        return (
          ...
          u == "?" && i.eat(".") ? j(".") : j("operator", "operator", i.current())
        )
      if (d.test(u)) {
        i.eatWhile(d)
        var g = i.current()
    ...
    function Y(i) {
      return function (l, u) {
        var g = !1,
          E
        if (s && l.peek() == "@" && l.match(k)) return (u.tokenize = B), j("jsonld-keyword", "meta")
    ...
    function C(i, l) {
      ...
      if (!(u < 0)) {
        if (c) {
          var g = /:\s*(?:\w+(?:<[^>]*>|\[\])?|\{[^}]*\})\s*$/.exec(i.string.slice(i.start, u))
          g && (u = g.index)
        }
    ...
    function G(i, l, u, g, E) {
      ...
      for (
        ...
        if ($(u, g)) {
          ...
          return m.marked ? m.marked : u == "variable" && J(i, g) ? "variable-2" : l
        }
      }
    }
    ...
    function me(i) {
      ...
      if (((m.marked = "def"), !!A)) {
        ...
        t.globalVars && !we(i, l.globalVars) && (l.globalVars = new fe(i, l.globalVars))
      }
    }
    function oe(i, l) {
      if (l)
    ...
    function se(i) {
      return (
        i == "public" || i == "private" || i == "protected" || i == "abstract" || i == "readonly"
      )
    }
    function Pe(i, l, u) {
    ...
    function Be() {
      ;(m.state.context = new Pe(m.state.context, m.state.localVars, !1)), (m.state.localVars = _t)
    }
    function Ne() {
    ...
    function y(i, l) {
      var u = function () {
        ...
        else for (var q = g.lexical; q && q.type == ")" && q.align; q = q.prev) E = q.indented
    ...
    function _() {
      var i = m.state
      i.lexical.prev &&
        (i.lexical.type == ")" && (i.indented = i.lexical.indented), (i.lexical = i.lexical.prev))
    }
    _.lex = !0
    function F(i) {
      function l(u) {
        return u == i ? p() : i == ";" || u == "}" || u == ")" || u == "]" ? h() : p(l)
      }
      return l
    }
    function H(i, l) {
                      ...
                      : i == "function"
                        ...
                        : i == "for"
                          ...
                          : i == "class" || (c && l == "interface")
                            ? ((m.marked = "keyword"), p(y("form", i == "class" ? i : l), yn, _))
                            : i == "variable"
                              ? c && l == "declare"
                                ? ((m.marked = "keyword"), p(H))
                                : c &&
                                    (l == "module" || l == "enum" || l == "type") &&
                                  ...
                                  ? ((m.marked = "keyword"),
                                    l == "enum"
                                      ...
                                      : l == "type"
                                        ? p(bn, F("operator"), D, F(";"))
                                        : p(y("form"), be, F("{"), y("}"), tr, _, _))
                                  : c && l == "namespace"
                                    ? ((m.marked = "keyword"), p(y("form"), S, H, _))
                                    : c && l == "abstract"
                                      ? ((m.marked = "keyword"), p(H))
                                      : p(y("stat"), Zt)
                              : i == "switch"
                                ? p(y("form"), it, F("{"), y("}", "switch"), Ne, tr, _, _, ae)
                                : i == "case"
                                  ? p(S, F(":"))
                                  : i == "default"
                                    ? p(F(":"))
    ...
    function ot(i, l) {
      return i != "quasi" ? h() : l.slice(l.length - 2) != "${" ? p(ot) : p(Le, zt)
    }
    function zt(i) {
      if (i == "}") return (m.marked = "string-2"), (m.state.tokenize = T), p(ot)
    }
    function Jt(i) {
    ...
    function He(i) {
      return function (l) {
        return l == "." ? p(i ? Qt : vt) : l == "variable" && c ? p(Mi, i ? Xe : Ye) : h(i ? le : S)
      }
    }
    function vt(i, l) {
    ...
    function X(i, l, u) {
      function g(E, q) {
        ...
        return E == l || q == l ? p() : u && u.indexOf(";") > -1 ? h(i) : p(F(l))
      }
      return function (E, q) {
    ...
    function jn(i) {
      if (c && i == ":") return m.stream.match(/^\s*\w+\s+is\b/, !1) ? p(S, ki, D) : p(D)
    }
    function ki(i, l) {
    ...
    function It(i, l) {
      if (i == "variable" || m.style == "keyword") return (m.marked = "property"), p(It)
    ...
    function br(i, l) {
      return i != "quasi" ? h() : l.slice(l.length - 2) != "${" ? p(br) : p(D, Fi)
    }
    function Fi(i) {
      if (i == "}") return (m.marked = "string-2"), (m.state.tokenize = T), p(br)
    }
    function yr(i, l) {
    ...
    function Ge(i, l) {
      ...
      if (l == "extends" || l == "implements") return (m.marked = "keyword"), p(D)
      if (l == "?") return p(D, F(":"), D)
    }
    function Mi(i, l) {
      if (l == "<") return p(y(">"), X(D, ">"), _, Ge)
    ...
    function Ve(i, l) {
      ...
      if (i == "variable" || m.style == "keyword") return (m.marked = "property"), p(St, Ve)
    ...
    function Si(i) {
      return i == "string" ? p() : i == "(" ? h(S) : i == "." ? h(Ye) : h(ir, En, Er)
    }
    function ir(i, l) {
      return i == "{"
        ? Ct(ir, "}")
    ...
    function Tn(i, l, u) {
      return (
        ...
        (l.lastType == "quasi" && /\{\s*$/.test(i.string.slice(0, i.pos - (u || 0))))
      )
    }
    return {
      startState: function (i) {
        ...
        return t.globalVars && typeof t.globalVars == "object" && (l.globalVars = t.globalVars), l
      },
      token: function (i, l) {
        if (
          (i.sol() &&
        ...
        return O == "comment"
          ? u
          : ((l.lastType = O == "operator" && (P == "++" || P == "--") ? "incdec" : O),
            G(l, u, O, P, i))
      },
      indent: function (i, l) {
        ...
        for (
          ...
          (u == "}" ||
            ((E = i.cc[i.cc.length - 1]) && (E == Ye || E == Xe) && !/^[,\.=+\-*:?[\(]/.test(l)));
        ...
        var pe = g.type,
          Oe = u == pe
        return pe == "vardef"
          ? g.indented + (i.lastType == "operator" || i.lastType == "," ? g.info.length + 1 : 0)
          : pe == "form" && u == "{"
            ? g.indented
            : pe == "form"
              ? g.indented + n
    ...
    return {
      ...
      token: function (o, s) {
        return (
          ...
          o.start == s.basePos && ((s.baseCur = e.token(o, s.base)), (s.basePos = o.pos)),
          o.start == s.overlayPos &&
            ((o.pos = o.start), (s.overlayCur = t.token(o, s.overlay)), (s.overlayPos = o.pos)),
...
var bi = V(require("@codemirror/language")),
  ...
  gn = class {
    ...
    desktopShouldHighlight() {
      return mn.Platform.isDesktopApp && this.plugin.settings.syntax_highlighting
    }
    mobileShouldHighlight() {
      return mn.Platform.isMobile && this.plugin.settings.syntax_highlighting_mobile
    }
    async setup() {
      this.plugin.registerEditorSuggest(new un(this.plugin)),
        ...
        this.templaterLanguage === void 0 &&
          K(new w("Unable to enable syntax highlighting. Could not define language.")),
    ...
    async registerCodeMirrorMode() {
      ...
      if (e.name === "null") {
        K(new w("Javascript syntax mode couldn't be found, can't enable syntax highlighting."))
        return
      }
      let t = window.CodeMirror.customOverlayMode
      if (t == null) {
        K(new w("Couldn't find customOverlayMode, can't enable syntax highlighting."))
        return
      }
        ...
        let o = {
          ...
          token: function (s, a) {
            if ((s.sol() && a.inCommand && (a.freeLine = !0), a.inCommand)) {
              ...
              return (
                s.peek() == null && a.freeLine && (c += " line-background-templater-command-bg"),
            ...
            if (A != null) {
              ...
              return (a.inCommand = !0), `line-${dn} ${fn} ${Wo} ${a.tag_class}`
            }
