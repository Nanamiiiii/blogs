  ...
  return import_state.Prec.highest(
    import_view.ViewPlugin.fromClass(
      ...
      },
      {
        eventHandlers,
        provide: (plugin) =>
          import_view.EditorView.scrollMargins.of((view) => {
...
var ScrollOffset = class extends import_obsidian.Plugin {
  constructor() {
    ...
    this.calcRequiredOffset = (container, cursorHeight) => {
      ...
      let requiredOffset = settings.percentageMode
...
var ScrollOffsetSettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian.Setting(containerEl)
      ...
      .addToggle((comp) =>
        comp.setValue(this.plugin.settings.percentageMode).onChange((value) => {
    ...
    new import_obsidian.Setting(containerEl)
      ...
      .addText((text) =>
        text.setValue(this.plugin.settings.offset).onChange((value) => {
